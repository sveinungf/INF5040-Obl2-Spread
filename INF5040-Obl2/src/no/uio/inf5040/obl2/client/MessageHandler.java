...
public class MessageHandler {
	...
	void handleInput(String command, double value) {		
		...
		case "withdraw":
			/*This command causes the balance to decrease by <amount>. This decrease should be 
			performed on all the replicas in the group.*/
		...
		case "addInterest":
			/*This command causes the balance to increase by <percent> percent of the current value. 
			In other words, the balance should be multiplied by (1 + <percent>/100). This update should
		...
		case "sleep":
			/*This command causes the client to do nothing for <duration> seconds.
		 	It is only useful in a batch file*/
			try {
